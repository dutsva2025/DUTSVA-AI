...
┏━━━━❮📝 ᴅᴇᴛᴇʟᴇꜱ 📝❯━━━
┃🗣️ 𝚄𝚜𝚎𝚛 : ${pushname}
┃🤖 𝙱𝚘𝚝 : ᴅᴜᴛsᴠᴀ ᴀɪ ${packageJson.version}
...
┗━━━━━━━━━━━━━━━
  ...
  TIKTOK: function (title, author, q) {
    return `
🎟️ *ᴅᴜᴛsᴠᴀ ᴀɪ ᴛɪᴋᴛᴏᴋ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ* 🎟️
...
🎧 Enjoy your music with Dutsva Ai  
        `.trim();
  },
  YTMP3: function (data) {
    return `
...
🎬 *Enjoy the video brought to you by Dutsva Ai!* 
        `.trim();
  },
  VIDEO: function (data) {
    return `
🎧𝐃𝐔𝐓𝐒𝐕𝐀 𝐀𝐈 𝐕𝐈𝐃𝐄𝐎 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃𝐄𝐑
...
${config.FOOTER || "🎼 Enjoy the music! 🎧"}`.trim();
  ...
  AIMODEPROMPT: function (userMessage) {
    return `
    You're an advanced AI assistant called "𝐃𝐮𝐭𝐬𝐯𝐚 𝐀𝐢." You're professional, respectful, and knowledgeable, always ready to assist with expertise. 👑 Your goal is to provide helpful, accurate, and engaging responses while maintaining a courteous and professional tone.
